package com.practice.Java;
	...
	public class SingleNaukariProfileUpdate {
		...
		public static void readCredentials() throws IOException {
			reader = new FileReader("src/test/resources/Config/Credentials.properties");
			p = new Properties();
			p.load(reader);
		...
		private static boolean isDisplayedOnPage(WebElement we) {
			try {
		...
		public static void main(String[] args) throws IOException, InterruptedException, AWTException {
			...
			viewProfile.click();
			try {
				WebElement modal = driver.findElement(By.className("//*[starts-with(@class,'crossIcon')]"));
				Boolean isDis = isDisplayedOnPage(modal);
				System.out.println("Modal is :: " + isDis);

				if (isDis) {
					System.out.println("Modal is true ");

					modal.click();
				}
			} catch (NoSuchElementException nsee) {
				System.out.println("NoSuchElementException handled " + nsee);
			}
			...
			String filename = "C:\\Users\\geeta\\Desktop\\Resume_Geeta_Borkar_Sr_QA_Profile.pdf";
